...
const Products = () => {
    ...
    // Initial Mock Data
    const mockProducts = [
        { id: 1, name: 'LED Tubelight 20W', category: 'LED Lights', price: 150, description: 'High brightness 20W LED tubelight with energy saving technology.', imageUrl: '/images/led-tubelight-20w.png' },
        { id: 2, name: 'LED Bulb 9W', category: 'LED Lights', price: 90, description: 'Energy efficient 9W cool white LED bulb with 1 year warranty.', imageUrl: 'https://images.pexels.com/photos/45072/pexels-photo-45072.jpeg?auto=compress&cs=tinysrgb&w=500' },
        { id: 3, name: 'Ceiling Fan', category: 'Fans', price: 1800, description: 'High speed ceiling fan with aerodynamic blades and silent motor.', imageUrl: '/images/ceiling-fan-white.png' },
        { id: 4, name: 'PVC Pipes', category: 'Pipes', price: 150, description: 'ISI marked PVC conduit pipes for electrical wiring.', imageUrl: '/images/pvc-pipes.png' },
    ];
            ...
            {showInquiryModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                    ...
                    >
                        ...
                        <h2 className="text-2xl font-bold mb-2">Inquire Product</h2>
                        <p className="text-gray-500 mb-6">Interested in <span className="font-semibold text-gray-900">{selectedProduct?.name}</span>?</p>
